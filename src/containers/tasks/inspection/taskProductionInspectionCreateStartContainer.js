...
class TaskProductionInspectionCreateStartContainer extends Component {
    ...
    onBackClick(e) {
        e.preventDefault();
        this.props.history.push("/task-start/"+this.props.taskDetail.slug);
    }
    ...
    onSuccessfulSubmissionCallback() {
        ...
        const aURL = '/task/production-inspection/'+this.state.slug+'/crop/0';
    ...
    render() {
        ...
        return (
            <TaskProductionInspectionCreateStartComponent
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(TaskProductionInspectionCreateStartContainer);
