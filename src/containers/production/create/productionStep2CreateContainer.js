...
import ProductionStep2CreateComponent from "../../../components/production/create/productionStep2CreateComponent";
...
class ProductionStep2CreateContainer extends Component {
    ...
    componentDidMount() {
        this.props.pullCropLifeCycleStageList(this.props.user, 1, CROP_PLANT_TYPE); // Get latest data from API.
        this.props.pullCropDataSheetList(this.props.user, 1, CROP_PLANT_TYPE); // Get latest data from API.
