...
export function postProductionInspectionDetail(data, successCallback, failedCallback) {
    return dispatch => {
        ...
        const url = MIKAPONICS_PRODUCTION_INSPECTION_LIST_CREATE_API_URL;

        // Perform our API submission.
        customAxios.post(url, buffer).then( (successResponse) => {
            // Decode our MessagePack (Buffer) into JS Object.
            const responseData = msgpack.decode(Buffer(successResponse.data));
